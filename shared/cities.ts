...
export const CITIES: CityDef[] = [
  ...
  },
  {
    ...
    region: "Minnesota, USA",
    slugMatchers: ["edina"],
    center: [44.8999, -93.3526],
    defaultZoom: 12,
    probeZoom: 12,
    boundaryFile: "edina-boundary.json",
  },
  {
    id: "richfield",
    name: "Richfield",
    region: "Minnesota, USA",
    slugMatchers: ["richfield"],
    center: [44.8769, -93.2842],
    defaultZoom: 13,
    probeZoom: 13,
    boundaryFile: "richfield-boundary.json",
  },
  {
    id: "rochester",
    name: "Rochester",
    region: "Minnesota, USA",
    slugMatchers: ["rochester"],
    center: [44.0167, -92.4764],
    defaultZoom: 11,
    probeZoom: 12,
    boundaryFile: "rochester-boundary.json",
  },
  {
    id: "apple_valley",
    name: "Apple Valley",
    region: "Minnesota, USA",
    slugMatchers: ["apple_valley"],
    center: [44.7543, -93.1746],
    defaultZoom: 12,
    probeZoom: 12,
    boundaryFile: "apple-valley-boundary.json",
  },
];
